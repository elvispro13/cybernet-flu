                      ...
                      children: <Widget>[
                        ...
                        OutlinedButton(
                          ...
                          onPressed:  _connected?() async {
                            ...
                            list.add(LineText(type: LineText.TYPE_IMAGE, content: base64Image, align: LineText.ALIGN_CENTER, linefeed: 1, width: 200));

                            list.add(LineText(type: LineText.TYPE_TEXT, content: '================================', linefeed: 1));
                            list.add(LineText(type: LineText.TYPE_TEXT, content: 'RTN:01021995000303', linefeed: 1));
                            list.add(LineText(type: LineText.TYPE_TEXT, content: 'TEL:98602174', linefeed: 1));
...
//                             list.add(LineText(linefeed: 1));
                        ...
                        OutlinedButton(
                          ...
                          onPressed:  _connected?() async {
                            ...
                            List<LineText> list1 = [];
                            ByteData data = await rootBundle.load("assets/logo_negro.jpg");
                            List<int> imageBytes = data.buffer.asUint8List(data.offsetInBytes, data.lengthInBytes);
                            String base64Image = base64Encode(imageBytes);
